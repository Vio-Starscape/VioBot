...
import aiopytesseract.constants
...
# Needed to add custom languages
# aiopytesseract.constants.TESSERACT_LANGUAGES.add("starlstm_final")
...
async def get_amount(img: np.ndarray):
    ...
    output = await aiopytesseract.image_to_string(
        ...
        tessdata_dir="./tessdata",
        config=[
            ("tessedit_char_whitelist", "0123456789ed")
        ]
    )
